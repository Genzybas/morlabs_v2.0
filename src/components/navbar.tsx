...
const navItems = {
  ...
  Tools: [
    { name: "Sandbox", description: "Test environment", href: '/docs' },
  ...
  forum: [
    { name: "DAO Voting", description: "Participate", href: '/docs' }, 
    { name: "Discussion Forum", description: "Engage", href: '/docs' }, 
    { name: "Contribute", description: "Join Us", href: '/docs' }, 
  ],
  morlabs: [
    { name: "About", description: "Learn More", href: '/docs' }, 
    { name: "Contact", description: "Get in Touch", href: '/docs' }, 
    { name: "Careers", description: "Join Our Team", href: '/docs' }, 
  ],
  docs: [
                  ...
                  <div className="p-4 grid grid-cols-4 gap-4">
                    ...
                    <div>
                      ...
                      {navItems.APIs.map((item) => (
                        <MenuItem key={item.name} className="flex items-center justify-between text-white">
